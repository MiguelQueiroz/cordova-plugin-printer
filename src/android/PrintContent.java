...
class PrintContent
{
    ...
    private ContentType getContentType (@Nullable String path)
    {
        ...
        else if (path.startsWith("data:application/pdf;base64,"))
        {
        ...
        else if (path.matches("^[a-z0-9]+://.+"))
        {
            ...
            if (mime == null) return ContentType.UNSUPPORTED;
    ...
    private BufferedInputStream open (@NonNull String path)
    {
        ...
        {
            stream = io.openBase64("base64://" + path.substring("data:application/pdf;base64,".length()));
        }

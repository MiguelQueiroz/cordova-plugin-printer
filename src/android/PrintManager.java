...
class PrintManager
{
                               ...
                               @NonNull PrintOptions options)
    {
        ...
        // PDF printing starts on Cordova's worker thread, but the Android print
        // dialog must be opened on the activity's UI thread.
        ((Activity) context).runOnUiThread(() -> getPrintService().print(jobName, adapter, attrs));
    }
